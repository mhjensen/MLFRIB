...
%%%
\item[FRIB relevance:] We expect that many of the new FRIB experiments will produce larg eamounts of data. To classify various events of interest is then a task which requires a large degree of automation. We expect that these techniques will play a central role at FRIB. 
%%%
...
\begin{figure}[htb!]
\centering
\includegraphics[width=\linewidth]{figures/KRR_CC.pdf}
