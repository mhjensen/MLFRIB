...
%%%
\item[References:] In preparation
\end{description}
%%%
\end{minipage}
}
...
\begin{description}
%%%
\item[Participants:] C. Dembsky (u), C. Arbour (u), S. N. Liddick, M. Hjorth-Jensen
%%%
\item[Description:] 
...
%%%
\item[Description:] Central collisions of heavy nuclei serve as means of learning about bulk properties of nuclear matter at varying density, temperature and neutron-proton asymmetry, under laboratory conditions.  
